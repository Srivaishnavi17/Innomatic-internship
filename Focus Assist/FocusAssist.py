...
GEMINI_API_KEY = "AIzaSyAJDz1FHh5n_kE10ojvmSF348rfPeY50qI"  # Replace with your valid API key
...
st.markdown(
    ...
    <footer style="text-align:center;">
        <p>Powered by <strong>Google Gemini API</strong> | ©️  Srivaishnavi | Built with ❤️ using Streamlit</p>
    </footer>
    """,
    unsafe_allow_html=True,
)
